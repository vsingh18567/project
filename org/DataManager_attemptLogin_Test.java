...
public class DataManager_attemptLogin_Test {
    ...
    public void testFundsList() {
        DataManager dm = new DataManager(new WebClient("localhost", 3001) {
            @Override
            public String makeRequest(String resource, Map<String, Object> queryParams) {
                return "{\"status\":\"success\",\"data\":{\"_id\":\"1\",\"name\":\"hello\",\"description\":\"afund\",\"funds\":[{\"_id\":\"1\",\"name\":\"fund1\",\"description\":\"fund\",\"target\":123,\"donations\":[{\"contributor\":\"me\",\"amount\":1,\"date\":\"1/1/01\",}]}]}}";
            }
        })
        {
            @Override
        ...
        assertEquals(123, fund.getTarget(), 0);
